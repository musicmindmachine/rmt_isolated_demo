...
class LEDGlovesRMTController {
   public:
     ...
     */
    void IRAM_ATTR blockCallerWhileWritingBuffer(void);
   ...
   private:
    xSemaphoreHandle g_rmt_clkstoppoer_locks = NULL;
     ...
     */
    void IRAM_ATTR takeWritingBufferLock(void);

    /**
     * @brief Releases the writing buffer lock
     */
    void IRAM_ATTR releaseWritingBufferLock(void);
